...
<div class="modal modal-s" id="Register">
    <div class="modal-content">
        <div class="modal-header">
            <div class="ml-auto btn-close">
                <button type="button" id="RegisterClose" class="btn btn-transp">
        ...
        <div class="modal-body">
            ...
            <form class="login-form" id="login-form">
            	<div class="group-2">
               	...
               	<button class="btn btn-primary idcheck" type="button" id="idcheck" value="N">중복확인</button>
               </div>
               </button>
